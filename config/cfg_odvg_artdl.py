...
use_coco_eval = False
label_list = ['saint antony of padua', 'saint john the baptist', 'saint paul', 'saint francis', 'saint mary magdalene', 'saint jerome', 'saint dominic', 'saint mary', 'saint peter', 'saint sebastian']
dn_scalar = 100